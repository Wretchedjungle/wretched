...
bot.on("message", message => {
    ...
    if (command === "kick") {
      if (!author.roles.find(r => r.name === permissionrolename)) return message.channel.send(notauthorized);
    ...
    if (command === "verify") {
      ...
      if (!target.roles.find(r => r.name === "Verified")) {
        var add = message.guild.roles.find(role => role.name === "Verified");
